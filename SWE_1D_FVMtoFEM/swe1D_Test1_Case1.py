...
ax.set_title("Fig: 1 Water Depth Evolution at Selected Time Steps when u_const = 0.4 & n = 0.01")
ax.legend()

# Save the figure
plt.savefig("water_depth_evolution_1D_Case1.png", dpi=300)  # Save as PNG with high resolution

# Show the plot
# plt.show()
print("Successfully executed 1D simulation in slightly higher frictional area. Please open the water_depth_evolution_1D_Case1.png file in current folder to see the result. Thank you!!!")
