...
def load_csv_data():
    ...
    FenLand_height_values = np.loadtxt("CG_wse.csv", delimiter=",")  
    FenLand_x_vel_values = np.loadtxt("CG_x_vel.csv", delimiter=",")
    FenLand_y_vel_values = np.loadtxt("CG_y_vel.csv", delimiter=",")

    SWEmniCS_height_values = np.loadtxt("Balzano_p1_wse_cg.csv", delimiter=",")
    SWEmniCS_x_vel_values = np.loadtxt("Balzano_p1_xvel_cg.csv", delimiter=",")
    SWEmniCS_y_vel_values = np.loadtxt("Balzano_p1_yvel_cg.csv", delimiter=",")
